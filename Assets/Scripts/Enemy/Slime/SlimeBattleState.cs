...
public class SlimeBattleState : EnemyState
{
    ...
    public SlimeBattleState(Enemy _enemyBase, EnemyStateMachine _startMachine, string _animBoolName, Enemy_Slime _enemy) : base(_enemyBase, _startMachine, _animBoolName)
    {
        this.enemy = _enemy;
    }
